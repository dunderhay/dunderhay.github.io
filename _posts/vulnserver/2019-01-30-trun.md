...
layout: post
tags: [vulnserver]
excerpt: "Vanilla Stack Overflow"
---
...
The vulnerable line: `strcpy(Buffer2S, Input)`, simply copies the memory contents of `Input` into `Buffer2S` until a __“\0”__ (null-byte) is encountered, without checking the size of area allocated to `Buffer2S`.

The command will execute fine if we run the `TRUN` command on a string smaller than 2000 characters:

<img src="/assets/images/vulnserver/trun/Stack-Overflow-trun1.png" alt="trun-stack-normal" width="400"/>
...
<img src="/assets/images/vulnserver/trun/Stack-Overflow-trun2.png" alt="trun-stack-overflow" width="400"/>
...
<img src="/assets/images/vulnserver/trun/trun-send-crash1.png" alt="trun-send-crash1" width="700"/>
...
<img src="/assets/images/vulnserver/trun/trun-crash1.png" alt="trun-crash1" width="900"/>
...
<img src="/assets/images/vulnserver/trun/trun-crash1-stack.png" alt="trun-crash1-stack" width="900"/>

- `EAX`: The EAX register contains the entire buffer including the initial `TRUN .` command.
- `ESP`: The Stack Pointer has been contains part of the user supplied provided buffer.
...
<img src="/assets/images/vulnserver/trun/trun-crash1-eip.png" alt="trun-crash1-eip" width="900"/>
...
<img src="/assets/images/vulnserver/trun/trun-generate-unique-string.png" alt="trun-generate-unique-string" width="700"/>
...
<img src="/assets/images/vulnserver/trun/trun-send-unique-string.png" alt="trun-send-unique-string" width="700"/>

Looking at the updated value of the `EIP` register in the debugger:

<img src="/assets/images/vulnserver/trun/trun-crash-unique-string.png" alt="trun-crash-unique-string" width="900"/>
...
<img src="/assets/images/vulnserver/trun/trun-crash-find-offset.png" alt="trun-crash-find-offset" width="700"/>
...
<img src="/assets/images/vulnserver/trun/trun-send-crash2.png" alt="trun-send-crash2" width="700"/>

<img src="/assets/images/vulnserver/trun/trun-crash2-eip1.png" alt="trun-crash2-eip1" width="900"/>
...
<img src="/assets/images/vulnserver/trun/trun-crash2-eip2.png" alt="trun-crash2-eip2" width="900"/>
...
<img src="/assets/images/vulnserver/trun/trun-jmp-esp-mona.png" alt="trun-jmp-esp-mona" width="900"/>

Go to the memory address and confirm the `JMP ESP` instruction:

<img src="/assets/images/vulnserver/trun/trun-jmp-esp-instruction.png" alt="trun-jmp-esp-instruction" width="700"/>
...
<img src="/assets/images/vulnserver/trun/trun-jmp-esp-stack.png" alt="trun-jmp-esp-stack" width="900"/>
...
<img src="/assets/images/vulnserver/trun/trun-badchars.png" alt="trun-badchars" width="900"/>
...
<img src="/assets/images/vulnserver/trun/trun-generate-shellcode.png" alt="trun-generate-shellcode" width="700"/>
...
<img src="/assets/images/vulnserver/trun/trun-send-shellcode.png" alt="trun-send-shellcode" width="700"/>

Getting a meterpreter shell from the victim:

<img src="/assets/images/vulnserver/trun/trun-metasploit-listener.png" alt="trun-metasploit-listener" width="700"/>
