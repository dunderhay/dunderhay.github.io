...
Now that we have a valid TGT, we need to request a Ticket Granting Service (TGS) ticket with Kerberos S4U2Self. This can be done using [DirkJam’s gets4uticket](https://github.com/dirkjanm/PKINITtools/blob/master/gets4uticket.py) script to obtain a Kerberos service ticket (TGS) to the CIFS service for the local administrator of the DC - this is known as a silver ticket 🎟.
...
<p align="left">
  <img width="100%" src="/assets/images/ad/adcs-esc8/rpcdump-spoolss.png"/>
</p>
